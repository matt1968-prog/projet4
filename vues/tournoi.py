class Tournoi:
    ...
    def __init__(self, nom_tournoi, lieu_tournoi, date_debut_tournoi, date_fin_tournoi, description, type_tournoi, nombre_tours):
        self.nom_tournoi = nom_tournoi  #, lieu_tournoi, date_debut_tournoi, date_fin_tournoi, description, type_tournoi, nombre_tours)
